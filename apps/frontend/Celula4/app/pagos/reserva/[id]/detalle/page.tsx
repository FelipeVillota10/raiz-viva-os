...
import { consultarRespuesta, descargarComprobante } from '@/lib/services/pago.service'
import type { EventoDetalle } from '@/lib/types/evento'
import type { PagoRespuesta } from '@/lib/types/pago'
        ...
        <div className="bg-white border border-[#e8e0d0] rounded-2xl p-5 sm:p-6 shadow-sm">
          ...
          <div className="space-y-2 mt-3 pt-3 border-t border-[#e0d8c8]">
            <div className="flex justify-between items-center">
              ...
              <span className="text-sm font-medium text-[#1a1a1a]">{evento.capacidad || 'N/A'}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-500">Costo:</span>
              <span className="text-sm font-semibold text-[#1a1a1a]">
                {evento.costo_evento ? `$${Number(evento.costo_evento).toLocaleString('es-CO')} COP` : 'N/A'}
              </span>
            </div>
          </div>
        </div>
